...
class ximalaya(object):
    ...
    def index_choose(self):
        xm_id = input(u'请输入要获取喜马拉雅节目的ID：') or int('54079726')
        xima.get_fm(xm_id)
        self.index_choose()
    ...
    def get_fm(self, xm_fm_id,lable='youshengshu'):
        ...
        html = '<h1 class="title dC_">剑仙在此丨大斌丨搞笑 & 修仙精品多人剧</h1>'

        soup = BeautifulSoup(html, 'html.parser')
        fm_title = soup.find('h1', class_='title dC_').text
        print('书名：' + fm_title)
        # 新建有声书ID的文件夹
